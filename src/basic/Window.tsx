    ...
    return (
        <WindowContext.Provider
            ...
            <section
                ...
                class="flex w-[40rem] h-[25rem] flex-col border border-gray-400 rounded overflow-hidden relative">
                <HeaderBar></HeaderBar>
                {props.children}
            </section>
        </WindowContext.Provider>
...
export const HeaderBar = () => {
    ...
    return (
        <header class="flex h-8 items-center window-handle px-2" ref={header}>
